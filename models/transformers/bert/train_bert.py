...
MODEL_CONFIGS: dict[str, dict[str, Any]] = {
    "bert": {
        ...
        "output_dir": "outputs_silver_grade_only_bert_base_german_cased",
        "learning_rate": 2e-5,
...
# BERT supports 512 tokens.
MAX_SEQ_LENGTH = 512
RANDOM_SEED = 42

# Comparable to LLM protocol: 2 epochs on silver labels.
NUM_TRAIN_EPOCHS = 2
WEIGHT_DECAY = 0.01
WARMUP_STEPS = 100
...
def prepare_train_dataframe(df: pd.DataFrame) -> pd.DataFrame:
    ...
    train_df["labels"] = train_df[GRADE_COL].astype(float)
